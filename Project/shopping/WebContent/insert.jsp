...
<div class="a" style="text-align: center;"><b>상품등록</b></div>
...
<div class="container">
		<div class="row">
			<div class="col-md-7">
				<form name="newProduct" action="insertAction.jsp" class="form-horizontal" method="post"  enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<select name="pId">
						    ...
						    <option value="동대문 종합시장">동대문 종합시장</option>
						    <option value="망원시장">망원시장</option>
						    <option value="마포시장">마포시장</option>
						    </select>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<div class="col-sm-offset-2 col-sm-10 ">
							<input type="submit" value="상품등록" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">  
