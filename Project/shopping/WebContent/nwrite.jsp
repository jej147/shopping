...
<div class="row">
  ...
  <div class="col-9">
  <form method="post" name="writeform" action="nwriteAction.jsp">
<table class="table table-striped">
  <tr>
    <td  width="70" align="center">제 목</td>
    <td  width="330" align="left">
    <input type="text" size="38" maxlength="50" name="nTitle" style="ime-mode:active; font-size: 15px;"></td>	
  </tr>
  <tr>
    <td  width="70" align="center" >내 용</td>
    <td  width="330" align="left">
    <textarea name="nContent" rows="13" cols="40" 
    style="ime-mode:active; font-size: 15px;" maxlength="2048"></textarea> </td>
  </tr>
  <tr>      
    <td colspan=2 align="right"> 
      <input type="submit" value="글쓰기" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">  
      <input type="reset" value="다시작성" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">
      <input type="button" value="목록보기" OnClick="window.location='news.jsp'" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">
    </td>
  </tr>
</table>       
</form>
