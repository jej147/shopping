...
<div class="a" style="text-align: center;"><b>오시는길</b></div>
...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
     <div class="link">
      ...
      <a class="nav-link" href="map.jsp" style="color: black; background-color: silver;">오시는길</a>
  ...
  <div class="col-9">
    <img alt="map" src="image/map.PNG" style="width: 300px;">
         대구광역시 서대구로5길 2-5 (두류네거리 방면 삼익맨션 부근)
  </div>
</div>
