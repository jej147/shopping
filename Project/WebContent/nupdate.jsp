...
<div class="row">
  ...
  <div class="col-9">
  <form method="post" name="writeform" action="nupdateAction.jsp?nId=<%= nId %>">
<table class="table table-striped">
  <tr>
    <td  width="70" align="center">제 목</td>
    <td  width="330" align="left">
    <input type="text" size="38" maxlength="50" name="nTitle" style="ime-mode:active; font-size: 15px;" value="<%= news.getnTitle() %>"></td>	
  </tr>
  <tr>
    <td  width="70" align="center" >내 용</td>
    <td  width="330" align="left">
    <textarea name="nContent" rows="13" cols="40" 
    style="ime-mode:active; font-size: 15px;" maxlength="2048"><%= news.getnContent() %></textarea> </td>
  </tr>
  <tr>      
