...
<div class="a" style="text-align: center;"><b>회사소개</b></div>
...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" href="company.jsp" style="color: black; background-color: silver;">회사소개</a>
  ...
  <div class="col-9">
    지역 전통시장의 상권을 살리기 위한 전통시장만의 정보, 배달 서비스 웹 사이트....
  </div>
</div>
<hr class="featurette-divider">
  <!-- FOOTER -->
