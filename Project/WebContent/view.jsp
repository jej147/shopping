...
<table class="table table-striped" class="table" style="text-align: center; border: 1px solid #dddddd;">
  ...
  <tr>
    ...
    <td  width="330" align="left">
    <%= board.gettDate().substring(0,11) + 
    board.gettDate().substring(11,13) + "시" + board.gettDate().substring(14,16) + "분" %></td>	
  </tr>
  <tr>
    <td  width="70" align="center" >내 용</td>
    <td  width="330" align="left"><%= board.gettContent() %> </td>
  </tr>
  </table>      
   <div class="t" style="float: right;">
      <a href="board.jsp" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">목록</a>
      <%
      if(userId != null && userId.equals(board.getUserId())){
      %>
    	  <a href="update.jsp?tId=<%= tId %>" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">수정</a>
    	  <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?tId=<%= tId %>" class="btn" style="background-color: rgba(0, 0, 0, 0.1);">삭제</a>
     <% 
      }
      %>   
      </div>  
